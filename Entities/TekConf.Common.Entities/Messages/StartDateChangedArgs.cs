...
{
	public class StartDateChangedArgs : EventArgs
	{
		public StartDateChangedArgs(string sessionSlug, DateTime oldValue, DateTime newValue)
		{
		...
		public override bool Equals(object obj)
		{
			...
			var p = obj as StartDateChangedArgs;
			if (p == null)
				return false;
