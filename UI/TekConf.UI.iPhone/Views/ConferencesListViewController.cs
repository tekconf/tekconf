...
{
	public partial class ConferencesListViewController : UIViewController
	{
		...
		public override void ViewDidLoad ()
		{
			...
			_client.GetSessions ("thatconference-2013", sessions => 
				...
				InvokeOnMainThread (() => 
				                    { 
					conferencesTableView.Source = new ConferencesTableViewSource (this, sessions); 
		...
		public class ConferencesTableViewSource : UITableViewSource
		{ 
			...
			public ConferencesTableViewSource (ConferencesListViewController controller, IList<SessionsDto> sessions)
			{ 
