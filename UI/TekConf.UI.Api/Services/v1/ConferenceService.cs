...
namespace TekConf.UI.Api.Services.v1
{
	public class ConferenceService : MongoServiceBase
	{
		...
		public ConferenceService(ITinyMessengerHub hub, IRepository<ConferenceEntity> repository, IConfiguration configuration)
		{
			_hub = hub;
		...
		public object Post(CreateSpeaker speaker)
		{
			...
			try
			{
				...
				var conference = _repository.AsQueryable()
