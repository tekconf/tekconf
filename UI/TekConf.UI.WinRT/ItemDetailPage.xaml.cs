...
namespace TekConf.UI.WinRT
{
	...
	public sealed partial class ItemDetailPage : TekConf.UI.WinRT.Common.LayoutAwarePage
	{
		...
		protected override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
		{
			...
			var conferences = App.ViewModel.GroupedItems
					.SingleOrDefault(g => g.Conferences.Any(c => c.slug == (string)navigationParameter));
			var conference = conferences.Conferences.SingleOrDefault(x => x.slug == (string)navigationParameter);
			this.DefaultViewModel["Group"] = conferences.GroupMonthName;
			this.DefaultViewModel["Items"] = conferences.Conferences;
			this.flipView.SelectedItem = conference;
		}
