...
namespace TekConf.UI.WinRT
{
	...
	public class ConferencesViewModel
	{
		...
		{
			this.Items = new ObservableCollection<FullConferenceDto>();
		}

		public ObservableCollection<FullConferenceDto> Items { get; set; }
		...
		public async Task LoadConferences()
		{
			...
			var conferences = await repository.GetConferencesAsync("user", showPastConferences: true);
