...
namespace TekConf.Api.App_Start
{
    ...
    using TekConf.Api.DependencyResolution;
    ...
    public static class StructuremapMvc
    {
        ...
        public static void End()
        {
            ...
            StructureMapDependencyScope.DisposeParentContainer();
        }

        public static void Start()
        {
            IContainer container = IoC.Initialize();
            StructureMapDependencyScope = new StructureMapDependencyScope(container, new HttpContextNestedContainerScope());
