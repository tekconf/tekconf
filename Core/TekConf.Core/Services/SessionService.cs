...
//		private SessionService(bool isRefreshing, IMvxFileStore fileStore, ILocalConferencesRepository localConferencesRepository, ISQLiteConnectionFactory factory, ICacheService cache, Action<SessionDetailDto> success, Action<Exception> error)
//		{
